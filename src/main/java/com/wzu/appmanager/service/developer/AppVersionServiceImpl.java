...
public class AppVersionServiceImpl implements AppVersionService {
	...
	public boolean appsysadd(AppVersion appVersion) throws Exception {
		...
		versionId = Integer.parseInt(String.valueOf(appVersion.getId()));
		if(appInfoMapper.updateVersionId(versionId, Integer.parseInt(appVersion.getAppId().toString())) > 0 && flag){
			flag = true;
		}
		return flag;
	}
